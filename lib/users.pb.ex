...
defmodule EventStore.Client.Users.Users.Service do
  @moduledoc false
  use GRPC.Service, name: "event_store.client.users.Users"
...
defmodule EventStore.Client.Users.Users.Stub do
  @moduledoc false
  use GRPC.Stub, service: EventStore.Client.Users.Users.Service
end
