...
defmodule EventStore.Client.Streams.Streams.Service do
  @moduledoc false
  use GRPC.Service, name: "event_store.client.streams.Streams"
...
defmodule EventStore.Client.Streams.Streams.Stub do
  @moduledoc false
  use GRPC.Stub, service: EventStore.Client.Streams.Streams.Service
end
