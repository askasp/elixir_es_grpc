...
defmodule EventStore.Client.Operations.Operations.Service do
  @moduledoc false
  use GRPC.Service, name: "event_store.client.operations.Operations"
...
defmodule EventStore.Client.Operations.Operations.Stub do
  @moduledoc false
  use GRPC.Stub, service: EventStore.Client.Operations.Operations.Service
end
